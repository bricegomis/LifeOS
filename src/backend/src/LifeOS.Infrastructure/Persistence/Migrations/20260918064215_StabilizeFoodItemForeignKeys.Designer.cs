...
namespace LifeOS.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260918064215_StabilizeFoodItemForeignKeys")]
    partial class StabilizeFoodItemForeignKeys
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LifeOS.Domain.Planning.FrequencyRule", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("frequency_rules", (string)null);
                });

            modelBuilder.Entity("LifeOS.Domain.Planning.PlanningRule", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("HouseholdId", "Weekday", "MealType");

                    b.ToTable("planning_rules", (string)null);
                });
            ...
            modelBuilder.Entity("LifeOS.Domain.Stock.ShoppingListItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("HouseholdId", "WeekId");

                    b.ToTable("shopping_list_items", (string)null);
                });

            modelBuilder.Entity("LifeOS.Domain.Stock.StockItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("HouseholdId", "GroceryItemId")
                        .IsUnique();
            ...
            modelBuilder.Entity("LifeOS.Domain.WeekContexts.WeekContext", b =>
                {
                    b.Property<Guid>("HouseholdId")
                        .HasColumnType("uuid");

                    b.Property<string>("AlternatingWeekConfig")
                        .IsRequired()
                        .HasColumnType("jsonb");
                    ...
                    b.Property<string>("_weekModeOverrides")
                        .IsRequired()
                        .HasColumnType("jsonb")
                    ...
                    b.ToTable("week_contexts", (string)null);
                });
            ...
            modelBuilder.Entity("LifeOS.Domain.WeekContexts.WeekContext", b =>
                {
                    b.HasOne("LifeOS.Domain.Households.Household", null)
                        .WithOne()
                        .HasForeignKey("LifeOS.Domain.WeekContexts.WeekContext", "HouseholdId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
